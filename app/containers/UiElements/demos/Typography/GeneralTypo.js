    ...
    return (
      <div style={background}>
        <Typography variant="h4" gutterBottom>
          Lorem ipsum dolor
          {' '}
          <span className={Type.bold}>sit amet</span>
        </Typography>
...
&nbsp;
        ...
        <Typography variant="h4" className={classNames(Type.light, Type.uppercase)} gutterBottom>
          Vestibulum nec mi
          {' '}
          <span className={Type.bolder}>suscipit</span>
        </Typography>
...
&nbsp;
        ...
        <Typography variant="h6" className={Type.lighter} gutterBottom>
          <span className={Type.bold}>Numbers</span>
          {' '}
looks great! 1234
          <span className={classNames(Type.bold, Type.italic, Type.underline)}>56</span>
7890
        </Typography>
...
123
            <sup className={Type.italic}>00</sup>
          </span>
        </Typography>
        <Divider className={classes.divider} />
